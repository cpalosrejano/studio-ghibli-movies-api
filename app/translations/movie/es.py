...
translations = {
     ...
     "Kiki's Delivery Service" : MovieTranslation(
          ...
          description = "Kiki (o Nicky en el doblaje español) es una joven bruja de 13 años, en periodo de entrenamiento, que se divierte volando en su escoba junto a Jiji, un sabio gato negro. Según la tradición, todas las brujas de esa edad deben abandonar su hogar durante un año para saber valerse por sí mismas. Así, ella descubrirá lo que significa la responsabilidad, la independencia y la amistad. En su camino Kiki (Nicky) y Jiji harán un nuevo amigo, Tombo, con el que vivirán extraordinarias aventuras."
     ),
     ...
     "Porco Rosso" : MovieTranslation(
          title = "Porco Rosso",
          description = "Periodo de entreguerras. Porco es un cerdo aviador que frustra todos los actos de piratería perpetrados por los piratas aéreos del Adriático. Éstos, decididos a acabar con el valiente y hábil aviador, se ponen de acuerdo para contratar a un aventurero americano cuya misión será eliminarlo."
     ),
     "Ocean Waves" : MovieTranslation(
          title = "Puedo escuchar el mar",
          description = "Una chica de Tokio acaba de ser trasladada a una de las escuelas superiores de la ciudad de Kochi. Es guapa, buena en los deportes y en los estudios, pero de algún modo no consigue adaptarse a la vida social de la escuela. A ese mismo colegio pertenecen Taku Morisaki y Yukata Matsuno, dos grandes amigos, el primero de los cuales empieza a interesarse visiblemente por la recién llegada Muto."
     ),
     "Pom Poko" : MovieTranslation(
          title = "Pompoko",
          description = "Ante la inminente destrucción de un frondoso bosque cercano a una ciudad, cuyos dirigentes quieren construir en su lugar una urbanización, los mapaches que viven en el bosque intentarán sabotear la operación para así conservar sus hogares."
     ),
     "Whisper of the Heart" : MovieTranslation(
          title = "Susurros del corazón",
          description = "Una joven estudiante amante de los libros descubre que todos los libros que ha elegido en la biblioteca han sido previamente elegidos por una misma persona. Cuando descubre quién es conoce a Seiji, un joven que está aprendiendo el arte de fabricar violines."
     ),
     "Princess Mononoke" : MovieTranslation(
          title = "La princesa Mononoke",
          description = "Con el fin de curar la herida que le ha causado un jabalí enloquecido, el joven Ashitaka sale en busca del dios Ciervo, pues sólo él puede liberarlo del sortilegio. A lo largo de su periplo descubre cómo los animales del bosque luchan contra hombres que están dispuestos a destruir la Naturaleza."
     ),
     "My Neighbors the Yamadas" : MovieTranslation(
          title = "Mis vecinos los Yamadas",
          description = "Basada en el famoso manga de Hisachi Ishii, esta película cuenta pequeñas e imaginativas historias de la vida diaria de una típica familia de clase media de Tokyo. Los Yamada son Takashi y Matsuko (el padre y la madre), Shige (la suegra), Noboru (el hijo), Nonoko (la hija) y Pochi (el perro de la familia)."
     ),
     ...
     "Howl's Moving Castle" : MovieTranslation(
          ...
          description = "Narra la historia de Sophie, una joven sobre la que pesa una horrible maldición que le confiere el aspecto de una anciana. Sophie decide pedir ayuda al mago Howl, que vive en un castillo ambulante, pero tal vez sea Howl quien necesite la ayuda de Sophie."
     ),
